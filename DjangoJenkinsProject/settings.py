"""
Django settings for DjangoJenkinsProject project.
...
SECRET_KEY = 'yfupkn&5=(@s=*f!o-d-bdmjb@ud7)-^0d=f7!x-fj#ffklx)5'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','base_app','django_jenkins',
]
...
ROOT_URLCONF = 'DjangoJenkinsProject.urls'
...
WSGI_APPLICATION = 'DjangoJenkinsProject.wsgi.application'
